(function () {
    ...
    const solidprimary1toastExample = document.getElementById(
        'solid-primary1Toast'
    )
    ...
    const solidprimary2toastExample = document.getElementById(
        'solid-primary2Toast'
    )
    ...
    const solidprimary3toastExample = document.getElementById(
        'solid-primary3Toast'
    )
