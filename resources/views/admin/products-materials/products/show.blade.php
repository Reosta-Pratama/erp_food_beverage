...
@section('content')
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <div class="d-flex align-items-center gap-2">
            <a href="{{ route('products.categories.edit', $product->product_code) }}" 
    ...
    <div class="row">
        <div class="col-lg-8">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-4">
                            ...
                            <div>
                                ...
                                @else
                                    <span class="badge bg-dark fs-6">{{ $product->product_type }}</span>
                                @endif
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 mb-4">
                            ...
                            <div>
                                ...
                                <br><small class="text-muted">{{ $product->uom_type }}</small>
                            </div>
                        </div>
            ...
            <div class="card mb-4">
                <div class="card-header">
                    <h5 class="mb-0">
                        <i class="bi bi-cash-stack me-2"></i>Pricing Information
                    </h5>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-4 mb-3">
                            ...
                            <div>
                                ...
                                <small class="text-muted">per {{ $product->uom_code }}</small>
                            </div>
                        </div>
        ...
        <div class="col-lg-4">
            ...
            <div class="card mb-3">
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between mb-3">
                        ...
                        <strong><code>{{ $product->product_id }}</code></strong>
                    </div>
                    <div class="d-flex justify-content-between mb-3">
                        <span class="text-muted">Has BOM:</span>
                        <strong>
                            @if($hasBOM)
                    ...
                    <div class="d-flex justify-content-between">
                        <span class="text-muted">Has Recipe:</span>
                        <strong>
                            @if($hasRecipe)
                                <span class="text-success"><i class="bi bi-check-circle"></i> Yes</span>
                            @else
            ...
            <div class="card">
                <div class="card-header">
                    <h6 class="mb-0">
                        <i class="bi bi-clock-history text-muted me-2"></i>Metadata
                    </h6>
                </div>
                <div class="card-body">
                    <small class="text-muted d-block mb-2">
                        ...
                        {{ \Carbon\Carbon::parse($product->created_at)->format('d M Y, H:i') }}
                        <br><span class="text-muted">({{ \Carbon\Carbon::parse($product->created_at)->diffForHumans() }})</span>
                    </small>
                    <small class="text-muted d-block">
                        <strong>Updated:</strong><br>
                        {{ \Carbon\Carbon::parse($product->updated_at)->format('d M Y, H:i') }}
                        <br><span class="text-muted">({{ \Carbon\Carbon::parse($product->updated_at)->diffForHumans() }})</span>
                    </small>
                </div>
            </div>
        </div>
