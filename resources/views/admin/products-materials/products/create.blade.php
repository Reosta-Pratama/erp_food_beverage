...
@section('content')
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h2 class="fs-22 mb-0">Create New Product</h2>
    ...
    <form action="{{ route('products.store') }}" method="POST" 
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <select class="form-select single-select @error('product_type') is-invalid @enderror" 
                                ...
                                <option value="Raw Material" {{ old('product_type') == 'Raw Material' ? 'selected' : '' }}>Raw Material</option>
                                <option value="Semi-Finished" {{ old('product_type') == 'Semi-Finished' ? 'selected' : '' }}>Semi-Finished</option>
                                <option value="Finished Goods" {{ old('product_type') == 'Finished Goods' ? 'selected' : '' }}>Finished Goods</option>
                                <option value="Packaging" {{ old('product_type') == 'Packaging' ? 'selected' : '' }}>Packaging</option>
                            ...
                            <select class="form-select single-select @error('uom_id') is-invalid @enderror" 
                                ...
                                @foreach($uoms as $uom)
                                    ...
                                    <option value="{{ $uom->uom_id }}" 
                                            {{ old('uom_id') == $uom->uom_id ? 'selected' : '' }}>
                        ...
                        <div class="col-12">
                            ...
                            <textarea class="form-control @error('description') is-invalid @enderror" 
                                      ...
                                      name="description" 
                                      rows="4"
                                      placeholder="Product description, specifications, notes...">{{ old('description') }}</textarea>
        ...
        <div class="col-lg-4">
            ...
            <div class="card custom">
                <div class="card-header">
                    <div class="card-title">Product Guidelines</div>
                </div>
                    ...
                    <ul class="list-group list-group-flush small">
                        ...
                        <li class="list-group-item"> 
                            <div class="d-flex align-items-center">
                                ...
                                <div class="ms-2">
                                    Standard cost is used for inventory valuation
                                </div>
                            </div>
                        </li>
                        <li class="list-group-item"> 
                            <div class="d-flex align-items-center">
                                ...
                                <div class="ms-2">
                                    Selling price is used in sales orders
                                </div>
                            </div>
                        </li>
                    </ul>
            ...
            <div class="card custom">
                ...
                <div class="card-body">
                    <div class="small">
                        <div class="mb-2">
                            <span class="badge bg-secondary">Raw Material</span><br>
                            <small class="text-muted">Base ingredients/materials</small>
                        </div>
                        <div class="mb-2">
                            <span class="badge bg-warning">Semi-Finished</span><br>
                            <small class="text-muted">Work in progress items</small>
                        </div>
                        <div class="mb-2">
                            <span class="badge bg-success">Finished Goods</span><br>
                            <small class="text-muted">Ready to sell products</small>
                        </div>
                        <div class="mb-2">
                            <span class="badge bg-info">Packaging</span><br>
                            <small class="text-muted">Packaging materials</small>
                        </div>
                        <div>
                            <span class="badge bg-dark">Consumable</span><br>
                            <small class="text-muted">Consumable supplies</small>
                        </div>
                    </div>
                </div>
            </div>
