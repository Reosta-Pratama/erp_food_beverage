...
@section('content')
    ...
    <div class="row gx-4">
        ...
        <div class="col-12">
            <div class="card custom">
                <div class="card-header">
                    <div class="card-title">Different Type</div>
                </div>
                <div class="card-body">
                    <div class="row g-4">
                        <div class="col-xl-6">
                            <label for="basic-input" class="form-label">Basic Input:</label>
                            <input type="text" class="form-control" id="basic-input">
                        </div>
                        ...
                        <div class="col-xl-6">
                            <div class="row gap-2 gap-xl-0">
                                <div class="col-xl-3">
                                    <label for="type-color" class="form-label">Type Color</label>
                                    <input id="type-color" class="form-control form-input-color" type="color" value="#136bd0">
                                </div>
                        ...
                        <div class="col-xl-6">
                            <label for="type-url" class="form-label">Type Url</label>
                            <input id="type-url" class="form-control" type="url"  name="website" placeholder="http://example.com">
                        </div>
        ...
        <div class="col-xl-6">
            <div class="card custom">
                <div class="card-header">
                    <div class="card-title">Different Shape</div>
                </div>
                <div class="card-body">
                    <div class="row g-4">
                        <div class="col-xl-12">
        ...
        <div class="col-xl-6">
            <div class="card custom">
                <div class="card-header">
                    <div class="card-title">Different Border Style</div>
                </div>
                <div class="card-body">
                    <div class="row g-4">
                        <div class="col-xl-12">
        ...
        <div class="col-12">
            <div class="card custom">
                <div class="card-header">
                    <div class="card-title">Different Size</div>
                </div>
                <div class="card-body">
                    <div class="row g-1">
                        <div class="col-12">
        ...
        <div class="col-12">
            <div class="card custom">
                <div class="card-header">
                    <div class="card-title">Disabled Form</div>
                </div>
                <div class="card-body">
                    <form>
                        <fieldset disabled="">
    ...
    <div class="row gx-4">
        ...
        <div class="col-xl-6">
            <div class="row">
                ...
                <!-- Form Text (inline text)  -->
                <div class="col-12">
                    <div class="card custom">
                        <div class="card-header">
                            <div class="card-title">
                                Inline text can use any typical inline HTML element with nothing more than the
