...
@section('content')
                ...
                <div class="col-12">
                    <div class="card custom">
                        <div class="card-header">
                            <div class="card-title">Basic Elements</div>
                        </div>
                        <div class="card-body">
        ...
        <div class="col-xl-6">
            <div class="row">
                ...
                <div class="col-12">
                    <div class="card custom">
                        <div class="card-header">
                            <div class="card-title">Multiple Input</div>
                        </div>
                        <div class="card-body">
                            <div class="input-group">
                ...
                <div class="col-12">
                    <div class="card custom">
                        <div class="card-header">
                            <div class="card-title">Checkbox & Radio</div>
                        </div>
                        <div class="card-body">
                            <div class="input-group mb-3">
                ...
                <div class="col-12">
                    <div class="card custom">
                        <div class="card-header">
                            <div class="card-title">Segmented Button</div>
                        </div>
                        <div class="card-body">
                            <div class="input-group mb-3">
    ...
    <div class="row gx-4">
        ...
        <div class="col-xl-6">
            <div class="card custom">
                <div class="card-header">
                    <div class="card-title">Button With Dropdown</div>
                </div>
                <div class="card-body">
                    <div class="input-group mb-3">
