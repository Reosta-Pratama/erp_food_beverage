...
@section('content')
    ...
    <div class="row gx-4">
        ...
        <div class="col-xl-6">
            <div class="card custom">
                <div class="card-header">
                    <div class="card-title">Colored Progress</div>
                </div>
                <div class="card-body">
                    <div
                        class="progress mb-3"
            ...
            <div class="card custom">
                ...
                <div class="card-body">
                    ...
                    <div
                        ...
                        aria-valuemin="0"
                        aria-valuemax="100">
                        <div class="progress-bar progress-bar-striped bg-secondary" style="width: 25%"></div>
                    </div>
                    <div
                        class="progress mb-3"
                        role="progressbar"
        ...
        <div class="col-xl-6">
            <div class="card custom">
                <div class="card-header">
                    <div class="card-title">Different Height Progress</div>
                </div>
                <div class="card-body">
                    <div
        ...
        <div class="col-xl-6">
            <div class="card custom">
                <div class="card-header">
                    <div class="card-title">Label Progress</div>
                </div>
                <div class="card-body">
                    <div
                        class="progress mb-3"
        ...
        <div class="col-xl-6">
            <div class="card custom">
                <div class="card-header">
                    <div class="card-title">Multiple Bar Progress</div>
                </div>
                <div class="card-body">
        ...
        <div class="col-xl-6">
            <div class="card custom">
                <div class="card-header">
                    <div class="card-title">Custom Style 1</div>
                </div>
                <div class="card-body">
                    <div
        ...
        <div class="col-xl-6">
            <div class="card custom">
                <div class="card-header">
                    <div class="card-title">Custom Style 2</div>
                </div>
                <div class="card-body">
                    <div
        ...
        <div class="col-xl-6">
            <div class="card custom">
                <div class="card-header">
                    <div class="card-title">Custom Style 3</div>
                </div>
                <div class="card-body">
                    <div
        ...
        <div class="col-xl-6">
            <div class="card custom">
                <div class="card-header">
                    <div class="card-title">Custom Style 4</div>
                </div>
                <div class="card-body">
                    <div
        ...
        <div class="col-xl-6">
            <div class="card custom">
                <div class="card-header">
                    <div class="card-title">Custom Style 5</div>
                </div>
                <div class="card-body">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-xl-5">
                            <div class="border p-3">
                                <p class="fs-12 fw-medium mb-0 text-muted">Html<span class="float-end fs-10 fw-normal">25%</span>
                                </p>
                                <div
