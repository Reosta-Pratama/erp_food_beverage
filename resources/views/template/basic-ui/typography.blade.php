...
@section('content')
    ...
    <!-- Container -->
    <div class="row">
        <h6 class="mb-3">Basic Typography:</h6>
                ...
                <div class="col-12">
                    <div class="card custom">
                        <div class="card-header">
                            <div class="card-title">Heading H Tags</div>
                        </div>
                        <div class="card-body">
                    ...
                    <div class="card custom">
                        ...
                        <div class="card-body">
                            <p class="mb-1">
                                ...
                                dolorem fuga iste obcaecati natus eos officiis adipisci voluptatibus ipsum,
                            ...
                            <p class="mb-0">
                                ...
                                Repellendus aliquid consequatur aut doloremque assumenda voluptatem, id qui vero
        ...
        <div class="col-12">
            <div class="card custom">
                <div class="card-header">
                    <div class="card-title">Font Weight & Italic</div>
                </div>
                <div class="card-body">
            ...
            <div class="card custom">
                ...
                <div class="card-body">
                    ...
                    <p class="lh-lg mb-0">This is a long paragraph written to show how the
                        line-height of an element is affected by our utilities. Classes are applied to
                        the element itself or sometimes the parent element. These classes can be
        ...
        <div class="col-xl-6">
            <div class="row gx-4">
                ...
                <div class="col-12">
                    <div class="card custom">
                        <div class="card-header">
                            <div class="card-title">Text Wrapping & Overflow</div>
                        </div>
                        <div class="card-body">
                ...
                <div class="card-body">
                    <figure class="blockquote-container">
                        <blockquote class="blockquote mb-2">
                            <h6>Goodness isn't about avoiding falls, but about the courage to rise, stronger
                                and kinder, with every stumble.</h6>
                        </blockquote>
    ...
    <div class="row gx-4">
        ...
        <div class="col-xl-6">
            <div class="card custom">
                <div class="card-header">
                    <div class="card-title">Primary Blockquotes</div>
                </div>
                <div class="card-body">
        ...
        <!-- Secondary Blockquotes -->
        <div class="col-xl-6">
            <div class="card custom">
                <div class="card-header">
                    <div class="card-title">Secondary Blockquotes</div>
                </div>
                <div class="card-body">
        ...
        <div class="col-xl-6">
            <div class="card custom">
                <div class="card-header">
                    <div class="card-title">Warning Blockquotes</div>
                </div>
                <div class="card-body">
        ...
        <div class="col-xl-6">
            <div class="card custom">
                <div class="card-header">
                    <div class="card-title">Success Blockquotes</div>
                </div>
                <div class="card-body">
        ...
        <div class="col-xl-6">
            <div class="card custom">
                <div class="card-header">
                    <div class="card-title">Info Blockquotes</div>
                </div>
                <div class="card-body">
        ...
        <div class="col-xl-6">
            <div class="card custom">
                <div class="card-header">
                    <div class="card-title">Danger Blockquotes</div>
                </div>
                <div class="card-body">
