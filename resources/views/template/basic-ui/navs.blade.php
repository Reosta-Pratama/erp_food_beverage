...
@section('content')
                ...
                <div class="card-body">
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane text-muted" id="about1" role="tabpanel">
                            ...
                            <b>Making it over 2000 years old</b>. Richard McClintock, a Latin professor at
                            Hampden-Sydney College in Virginia, looked up one of the more obscure Latin
                            words, consectetur.
                        </div>
                        <div class="tab-pane text-muted" id="service1" role="tabpanel">
                            There are many variations of passages of
                            <b>Lorem Ipsum available</b>, but the majority have suffered alteration in some
    ...
    <div class="row gx-4">
                ...
                <div class="card-body">
                    <nav class="nav nav-style-1 nav-pills mb-3" role="tablist">
                        ...
                        <a
                            ...
                            role="tab"
                            href="#nav-cart"
                            aria-selected="true">Cart
                            <span class="badge bg-secondary ms-1 rounded-pill">32</span>
                        </a>
                        <a
                            class="nav-link"
                            data-bs-toggle="tab"
                            ...
                            <span class="badge bg-success ms-1 rounded-pill">4</span>
                        </a>
                        <a
                            class="nav-link"
                            data-bs-toggle="tab"
                    ...
                    <div class="tab-content">
                        <div class="tab-pane text-muted" id="nav-products" role="tabpanel">
                            ...
                            <b>How carnival cruises make you a better lover</b>. Why you'll never succeed at
                            daily deals. 11 ways cheapest flights can find you the love of your life. The
                            complete beginner's guide to mission trips. If you read one article about
        ...
        <!-- Justified Pill Tabs With Link -->
        <div class="col-xl-6">
            <div class="card custom">
                <div class="card-header">
                    <div class="card-title">Justified Pill Tabs With Link</div>
                </div>
                <div class="card-body">
                    <nav
                        ...
                        <a
                            ...
                            aria-selected="true">Cart
                            <span class="badge bg-info-transparent ms-1">Full</span>
                        </a>
                        <a
                            class="nav-link"
                            data-bs-toggle="tab"
                        ...
                        <a
                            ...
                            <span class="badge bg-warning-transparent ms-1">7</span>
                        </a>
                    </nav>
                    <div class="tab-content">
    ...
    <div class="row gx-4">
        <!-- Vertical Alignment With List -->
        <div class="col-xl-6">
            <div class="card custom">
                <div class="card-header">
                    <div class="card-title">Vertical Alignment With List</div>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-xl-3">
        ...
        <!-- Vertical Alignment With Link -->
        <div class="col-xl-6">
            <div class="card custom">
                <div class="card-header">
                    <div class="card-title">Vertical Alignment With Link</div>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-xl-4">
                            <nav class="nav nav-tabs flex-column nav-style-5" role="tablist">
                                <a
                                    ...
                                    aria-selected="false">
                                    <i class="ti ti-smart-home me-2 align-middle d-inline-block"></i>Home</a>
                                <a
                                    class="nav-link"
                                    data-bs-toggle="tab"
                                    role="tab"
                                    ...
                                    aria-selected="false">
                                    <i class="ti ti-archive me-2 align-middle d-inline-block"></i>About</a>
                                <a
                                    class="nav-link active"
                                    data-bs-toggle="tab"
                                    role="tab"
                                    ...
                                    aria-selected="true">
                                    <i class="ti ti-help me-2 align-middle d-inline-block"></i>Services</a>
                                <a
                                    class="nav-link"
                                    data-bs-toggle="tab"
                                    role="tab"
                                    ...
                                    aria-selected="false">
                                    <i class="ti ti-address-book me-2 align-middle d-inline-block"></i>Contacts</a>
                            </nav>
                        </div>
                        <div class="col-xl-8">
                            <div class="tab-content mt-2 mt-xl-0">
                                ...
                                <div
                                    ...
                                    role="tabpanel">
                                    Unbelievable healthy snack success stories. 12 facts about safe food handling
                                    tips that will impress your friends. Restaurant weeks by the numbers.
                                    <b>
                                        <i>Will mexican food ever rule the world? The 10 best thai restaurant youtube
                                            videos</i>
                                    </b>. How restaurant weeks can make you sick. The complete beginner's guide to
    ...
    <div class="row gx-4">
        ...
        <div class="col-xl-6">
            <div class="card custom">
                <div class="card-header">
                    <div class="card-title">Center Aligned Navs</div>
                </div>
                <div class="card-body">
                    <ul
        ...
        <div class="col-xl-6">
            <div class="card custom">
                <div class="card-header">
                    <div class="card-title">Right Aligned Navs</div>
                </div>
                <div class="card-body">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane show active text-muted" id="home-header" role="tabpanel">
                            <ul class="mb-0">
                                ...
                                <li>
                                    How travel coupons make you a better lover. Why cultural solutions are the new
                                    black. Why mom was header about travel insurances. How family trip ideas can
        ...
        <div class="col-xl-4">
            <div class="card custom">
                ...
                <div class="card-body">
                    <ul class="nav nav-tabs tab-style-1 d-sm-flex d-block" role="tablist">
                        <li class="nav-item">
                            <a
                                class="nav-link active"
                                data-bs-toggle="tab"
                                data-bs-target="#orders01"
                                aria-current="page"
                                href="#orders01">Orders</a>
                        </li>
                        <li class="nav-item">
                            <a
                                class="nav-link"
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="orders01" role="tabpanel">
                    ...
                    <ul
                        ...
                        <li class="nav-item" role="presentation">
                            <button
                                ...
                                aria-selected="true">
                                <i class="ri-gift-line me-1 align-middle"></i>Ordered</button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button
                                class="nav-link active"
                                ...
                                aria-selected="false">
                                <i class="ri-check-double-line me-1 align-middle"></i>Confirmed</button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button
                                class="nav-link"
                                ...
                                aria-selected="false">
                                <i class="ri-shopping-bag-3-line me-1 align-middle"></i>Shipped</button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button
                                class="nav-link"
                                ...
                                role="tab"
                                aria-selected="false">
                                <i class="ri-truck-line me-1 align-middle"></i>Delivery</button>
                        </li>
                    </ul>
                        ...
                        <div
                            ...
                            <ul class="ps-3 mb-0">
                                <li>Contrary to popular belief, Lorem Ipsum is not simply random text. It has
                                    ...
                                    years old. Richard McClintock.</li>
                            </ul>
                        </div>
                        <div
                            ...
                            <ul class="ps-3 mb-0">
                                <li>As opposed to using 'Content here, content here', making it look like
                                    ...
                                    Lorem Ipsum as their default model text, and a search.</li>
                            </ul>
                        </div>
                        <div
                            class="tab-pane fade text-muted"
                            ...
                            <ul class="ps-3 mb-0">
                                <li>but also the leap into electronic typesetting, remaining essentially
                                    ...
                                    containing Lorem Ipsum passages, and more recently.</li>
                            </ul>
                        </div>
                        <div
                            class="tab-pane fade text-muted"
                            ...
                            <ul class="list-unstyled mb-0">
                                <li>A Latin professor at Hampden-Sydney College in Virginia, looked up one of
                                    the more obscure Latin words, consectetur, from a Lorem Ipsum passage, and going
                                    through the cites of the word in classical literature.</li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div class="card-body">
                    ...
                    <div class="tab-content" id="myTabContent1">
                        <div
                            ...
                            tabindex="0">
                            <b>Lorem Ipsum is simply dummy text of the printing</b>
                            and typesetting industry. Lorem Ipsum has been the industry's.</div>
                        <div
                            class="tab-pane fade text-muted"
                            id="profile-tab-pane"
                            role="tabpanel"
                            aria-labelledby="profile-tab"
                            tabindex="0">Many desktop publishing packages as their default model text, and a search for
                            <b>'lorem ipsum'</b>
                            will over the years.</div>
                        <div
                            class="tab-pane fade text-muted"
                            id="contact-tab-pane"
                            role="tabpanel"
                            aria-labelledby="contact-tab"
                            tabindex="0">There,
                            <b>by injected humour</b>, or randomised words which don't look even slightly believable.</div>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <li class="nav-item" role="presentation">
                            <button class="nav-link active" id="products-tab" data-bs-toggle="tab"
                                ...
                                aria-controls="products-tab-pane" aria-selected="true"><i
                                    class="ri-gift-line me-1 align-middle d-inline-block"></i>Product</button>
                        </li>
                        <li class="nav-item" role="presentation">
                                ...
                                <table class="table mb-0">
                                    ...
                                    <tbody>
                                        <tr>
                                            <th scope="row">
                                                <span class="avatar avatar-sm bg-primary-transparent">
                                                    <img src="{{ asset('assets/images/200x200/1.jpg') }}" alt="img">
                                                </span>
                                            </th>
                                            <td>Alarm Clock</td>
                                            <td>Clocks</td>
                                        ...
                                        <tr>
                                            <th scope="row">
                                                <span class="avatar avatar-sm bg-primary-transparent">
                                                    <img src="{{ asset('assets/images/200x200/2.jpg') }}" alt="img">
                                                </span>
                                            </th>
                                            <td>Wrist Watch</td>
                                            <td>Gadgets</td>
                                        ...
                                        <tr>
                                            <th scope="row">
                                                <span class="avatar avatar-sm bg-primary-transparent">
                                                    <img src="{{ asset('assets/images/200x200/3.jpg') }}" alt="img">
                                                </span>
                                            </th>
                                            <td>Sport Shoes</td>
                                            <td>Footwear</td>
    ...
    <div class="row gx-4">
        ...
        <div class="col-xl-6">
            <div class="card custom">
                ...
                <div class="card-body">
                    <ul class="nav nav-tabs mb-3 tab-style-7 scaleX" id="myTab4" role="tablist">
                        <li class="nav-item" role="presentation">
                            <button
                                class="nav-link active"
                                id="home-style8-tab"
        ...
        <div class="col-xl-6">
            <div class="card custom">
                <div class="card-header">
                    <div class="card-title">Flex Utilities</div>
                </div>
                <div class="card-body">
                    <nav class="nav nav-pills flex-column flex-sm-row mb-3" role="tablist">
                        ...
                        <a
                            ...
                            aria-current="page"
                            href="#pill-flex-big"
                            aria-selected="false">More Data More The Tab Size</a>
                        <a
                            class="flex-sm-fill text-sm-center nav-link"
                            data-bs-toggle="tab"
                            role="tab"
            ...
            <div class="card custom">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-2">
                            <div
                                class="nav flex-column nav-pills me-3 vertical-tab-style-1"
                                id="v-pills-tab"
                                role="tablist"
                                ...
                                <button
                                    ...
                                    aria-selected="true">
                                    <i class="ti ti-user-circle me-1 align-middle d-inline-block"></i>
                                    <span>Profile</span>
                                </button>
                                <button
                                    ...
                                    aria-selected="false">
                                    <i class="ti ti-brand-samsungpass me-1 align-middle d-inline-block"></i>
                                    <span>Password</span>
                                </button>
                                <button
                                    class="nav-link text-start"
                                    ...
                                    aria-selected="false">
                                    <i class="ti ti-users me-1 align-middle d-inline-block"></i>
                                    <span>Team</span>
                                </button>
                                <button
                                    class="nav-link text-start"
                                    ...
                                    aria-selected="false">
                                    <i class="ti ti-file-invoice me-1 align-middle d-inline-block"></i>
                                    <span>Billing</span>
                                </button>
                                <button
                                    ...
                                    aria-selected="false">
                                    <i class="ti ti-brand-gmail me-1 align-middle d-inline-block"></i>
                                    <span>Email</span>
                                </button>
                            </div>
                        </div>
                                    ...
                                    <div class="d-sm-flex">
                                        ...
                                        <div>
                                            <div class="my-md-auto mt-4 ms-md-3">
                                                <h5 class="font-weight-semibold ms-2 mb-1 pb-0">ChatGPT</h5>
                                                <p class="text-muted ms-0 mb-2 pb-2 ">
                                                    <span class="me-3">Expert Web Developer</span>
                                                    <span class="me-3">West fransisco,Alabama</span>
                                                ...
                                                <p class="text-muted ms-0 mb-2">
                                                    ...
                                                    <span>+10 12345 6789</span>
                                                </p>
                                                <p class="text-muted ms-0 mb-2">
                                                    <span>
                                                        <i class="ti ti-brand-gmail me-2"></i>
                                                    </span>
                                                    <span class="font-weight-semibold me-2">Email:</span>
                                                    <span class="text-break">email.gpt@gmail.com</span>
                                                </p>
                                                <p class="text-muted ms-0 mb-2">
                                                    <span>
                                                    ...
                                                    <span class="text-break">openaieverywhere</span>
                                                </p>
    ...
    <div class="row gx-4">
        ...
        <!-- Vertical Tab Style 3 -->
        <div class="col-xl-6">
            <div class="card custom">
                <div class="card-header">
                    <div class="card-title">Vertical Tab Style 3</div>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-4">
                            <ul class="nav nav-tabs flex-column vertical-tabs-3" role="tablist">
                                <li class="nav-item">
                                    <a
                                        ...
                                        aria-selected="true">
                                        <i class="ti ti-user-pin me-2 align-middle d-inline-block"></i>Employees
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a
                                        ...
                                        aria-selected="true">
                                        <i class="ti ti-users me-2 align-middle d-inline-block"></i>Customers
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a
                                        ...
                                        aria-selected="true">
                                        <i class="ti ti-gift me-2 align-middle d-inline-block"></i>Products
                                    </a>
                                </li>
                            </ul>
                        </div>
    ...
    <div class="row gx-4">
        ...
        <div class="col-xl-6">
            <div class="card custom">
                <div class="card-header">
                    <div class="card-title">Tabs With Dropdown</div>
                </div>
                <div class="card-body">
                    <ul class="nav nav-tabs mb-3 border-0" role="tablist">
                        <li class="nav-item">
        ...
        <div class="col-xl-6">
            <div class="card custom">
                <div class="card-header">
                    <div class="card-title">Pill With Dropdown</div>
                </div>
                <div class="card-body">
